...
class HRPC {
  constructor(stream) {
    ...
    this._requestEncodings = new Map([
      ['@sparse/hello', getEncoding('@sparse/hello-request')],
      ['@sparse/ping', getEncoding('@sparse/ping-request')],
      ['@sparse/farewell', getEncoding('@sparse/hello-request')]
    ])
    this._responseEncodings = new Map([
      ['@sparse/hello', getEncoding('@sparse/hello-response')],
      ['@sparse/farewell', getEncoding('@sparse/hello-response')]
    ])
  ...
  async hello(args) {
    return this._call('@sparse/hello', args)
  }

  ping(args) {
    return this._callSync('@sparse/ping', args)
  }

  async farewell(args) {
    return this._call('@sparse/farewell', args)
  }

  onHello(responseFn) {
    this._handlers['@sparse/hello'] = responseFn
  }

  onPing(responseFn) {
    this._handlers['@sparse/ping'] = responseFn
  }

  onFarewell(responseFn) {
    this._handlers['@sparse/farewell'] = responseFn
  }
